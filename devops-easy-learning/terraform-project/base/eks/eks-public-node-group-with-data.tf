...
#   node_group_name = "${var.control_plane_name}-eks-public-node-group"
...
#   subnet_ids = [
#     # this will be (sensitive) in the output
#     # length(split(",", data.aws_ssm_parameter.vpc-public-subnet-ids.value)) #this does not work
