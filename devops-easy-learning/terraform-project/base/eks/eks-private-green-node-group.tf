...
# resource "aws_eks_node_group" "private-blue-nodes" {
#   # Name of the EKS Cluster. This will associate the cluster with the node group
#   cluster_name = aws_eks_cluster.demo.name

#   # Name of the EKS Node Group.
#   node_group_name = "${var.control_plane_name}-eks-private-blue-node-group"
...
#   tags = {
#     Name = "${var.control_plane_name} EKS Private Blue Node Group"
